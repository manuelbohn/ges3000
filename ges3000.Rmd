...
ggplot() +
  ...
  xlab("Picture")+
  guides(alpha = F)+
  scale_y_continuous(name = "Proportion Gesture from Same Dyad", limits = c(-0.05,1.05))+
  theme_few() + 
  scale_colour_solarized()
