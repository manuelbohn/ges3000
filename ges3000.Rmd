...
# Do 4yo need fewer prompts in trial 1 during uptake compared to spontaneous?
...
## model for difference between uptake and spontaneous
...
```{r comb age, cache = T}
# do age groups differ in the rate of combinatorial gestures across conditions?
...
## recode rate of combinatorial gestures
### model with random intercept for id is not able to reasonably estimate individual intercepts due to lack of varaition in individual's responses
### therefore, children who use combinatorial gestures in more than 50% of trials are coded as 1, those who do so in less trials, are coded as 0
...
## remove 6yo
## only select trials in which children differentiated
## remove transitive 3 condition because all children used combinatorial sequences in the trials in which they differentiated. Estimation for this condition fails due to lack of variation
...
## only select trial with combinatorial gesture sequences
## remove trials with "combinatorial_part"(partseq) becasue they only comprise S and O
