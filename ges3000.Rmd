...
A second coder re-coded 25% of test trials. Agreement between raters was 94% for differentiation ($\kappa$ = 0.80), 92% for gesture type ($\kappa$ = 0.90), 98% for combinatorial nature of the gesture ($\kappa$ = 0.93) and 92% for word order ($\kappa$ = 0.88).
