...
```{r compcomb, echo = F, fig.cap="Proportion of trials in which children used a holistic or combinatorial gesture sequence by condition and age.", fig.width = 10, fig.height = 3, fig.scale = 1}
hcp1 <- gram_data  %>%
