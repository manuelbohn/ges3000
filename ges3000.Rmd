...
m2 <- glmer(prompts ~ block*age*blocktrial + 
              (blocktrial|id) + (age_c|stimulus) , family = binomial, data = d2.m,
            control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
