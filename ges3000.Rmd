...
### Results and discussion
```{r part 1-6 production, include = FALSE}
...
m7 <- glmer(corr ~ age+day+(age+day|rater) + (1|video), family = binomial, data = d7, control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
