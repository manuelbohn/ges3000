...
diff <- ggplot() +
  geom_jitter(data = gram_plot_dif, aes(x = Age, y = diff, col = Age), alpha = .4, position = position_jitterdodge(jitter.width = .2, jitter.height = 0.05,dodge.width = 0.5))+
  geom_pointrange(data = gram_plot_dif2,aes(x = Age, y = mean, col = Age,ymin = ci_lower, ymax = ci_upper),position = position_dodge(width = .5), size = 0.7) +
  guides(alpha = F)+
...
cbydiff <- ggplot() +
  geom_jitter(data = gram_plot_compr_3, aes(x = diff, y = compr, col = Age), alpha = .4, position = position_jitterdodge(jitter.width = .2, jitter.height = 0.05,dodge.width = 0.5))+
  geom_pointrange(data = gram_plot_compr_3_2,aes(x = diff, y = mean, col = Age,ymin = ci_lower, ymax = ci_upper),position = position_dodge(width = .5), size = 0.7) +
  guides(alpha = F)+
  #facet_grid(~condition)+
  scale_y_continuous(name = "Proportion Correct", limits = c(-0.05,1.05))+
...
propcomb <- ggplot() +
  geom_jitter(data = gram_plot_compr_6, aes(x = condition, y = atom, col = Age), alpha = .4, position = position_jitterdodge(jitter.width = .2, jitter.height = 0.05,dodge.width = 0.5))+
  geom_pointrange(data = gram_plot_compr_7,aes(x = condition, y = mean, col = Age,ymin = ci_lower, ymax = ci_upper),position = position_dodge(width = .5), size = 0.7) +
  guides(alpha = F)+
...
combcomp <- ggplot() +
  geom_jitter(data = hcp1, aes(x = typediff_1, y = compr, col = Age), position = position_jitterdodge(jitter.width = .2, jitter.height = 0.01,dodge.width = 0.5), alpha = .4)+
  geom_pointrange(data = hcp2,aes(x = typediff_1, y = mean, col = Age,ymin = ci_lower, ymax = ci_upper),position = position_dodge(width = .5), size = 0.7) +
  #facet_wrap(~condition, nrow = 1)+
  guides(alpha = F)+
  scale_y_continuous(name = "Proportion Correct", limits = c(-0.05,1.05))+
...
y <-ggarrange(diff,propcomb, widths = c(1,2),  labels = c("A","B"), align = "hv",common.legend = T, legend = "right")
...
```{r}
ggsave("./plots/part2.png", width = 6, height = 3.5, scale = 1.5)
```
